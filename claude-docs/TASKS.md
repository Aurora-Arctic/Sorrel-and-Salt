...
- `name` unique among non-deleted rows on a partial index; `slug` unique the same way — on both tables
...
- All eight groups present, then all 52 categories, matching §6 exactly
