...
| **3 — Schema block**         | M6.2 · MB.24 · MB.28 · MB.31 · MB.29 · MB.30 · MB.32 · MB.33 · M4.1 · M4.1a · M4.2 · M4.2a · MB.34 · M4.4 · M4.4a · M4.6 · M7.1 · M9.2 · M10.2 · M10.4 · M1.18 · MB.25 | FK order. **MB.28 precedes M4.1**, since M4.1 transcribes DESIGN.md §5 and §5 must be correct first. **MB.31, MB.29, MB.30, MB.32 and MB.33 form one doc-and-tooling block ahead of M4.1**, in that order: MB.31 first because it removes the `TASKS.csv` obligation from every PR after it, MB.29 next because it is what retires MB.25 from this wave and MB.26 from the next, so it must precede both, MB.30 before M4.1 because `ingredients.workspaceId` is a foreign key and the spike decides what it points at, and MB.32/MB.33 anywhere in the block since they depend on nothing — placed here so the tooling change lands before there is code to retrofit, per the sweep-task rule. **MB.34 sits immediately before M4.4**, the first join table it governs: after M4.4, M10.2 and M10.4 ship, the same change becomes a contract migration. **M4.2a and M4.4a land before M1.18** so the trigger sweep covers both new tables in one pass — the hard ordering constraint in the whole change, since the sweep-task rule forbids a later "re-assert" task. M1.18's trigger closes the wave, attaching to every audited table at once. **M10.3 is deliberately excluded** — see below. MB.24 is merged. MB.25 sits last, and survives this wave only if MB.29 is rejected: it must precede Wave 4's M1.27, which would bake the Postgres image its roles live in. |
...
| **5 — Authorization**        | M6.3 · M6.4 · M10.3 · M6.5 · M6.6                                                                                                                                      | All seven workspace-scoped tables now exist, so M6.4's RLS sweep is complete rather than partial.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| **7 — GraphQL**              | M3.1 → M3.10, internal order unchanged                                                                                                                                 | M3.8's "representative service" and M3.10's `me` both have real targets now.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **8 — Compendium + admin**   | M4.5 · M4.7 · M4.7a · M4.8 · M8.2 · M8.5 · M8.8 · MB.11 · M5.1 · M5.2 · M5.3 · M5.4 · M5.9 · M5.10 · M5.10a · M5.5 · M5.6 · M5.6a · M5.7 · M5.8 · M8.6 · M8.7          | M5.5/M5.6 read and write through GraphQL, which is M8.5/M8.8 — so those move ahead of M5.5. M5.9/M5.10 build `IngredientForm`, which M5.5 consumes, so they precede it too. **M5.10a joins M5.9/M5.10 ahead of M5.5** because M5.5 consumes `IngredientForm`; **M5.6a follows M5.6 but precedes M5.7**, which gates it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| MB.24 | Decide the RLS role split and read-path identity                                             | merged  | MB.25, MB.26 |
