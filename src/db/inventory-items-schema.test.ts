...
import { inventoryItems, inventoryUnit, unitDimension } from './schema/inventory-items';
...
const SCHEMA_SOURCE = fileURLToPath(new URL('./schema/inventory-items.ts', import.meta.url));
