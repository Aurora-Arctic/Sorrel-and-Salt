...
// M0.35); it has since M1.7, and a mechanical guard in this repo is a file in
// src/test/. Moving them here is what puts the theme-default guard in CI at
// all — as a script it ran from pre-commit only, which a `--no-verify` skips.
//
