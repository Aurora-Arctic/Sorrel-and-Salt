...
// (tests/support/db-setup.ts). The authors, ingredients and categories are the
// seed's — the real parent tables demand NOT NULL names, slugs and audit
// stamps; the ingredients and categories are looked up in beforeAll, since the
// seed generates their ids.
